            ...
            steps {
                withSonarQubeEnv('SonarQube') {
                    bat '''
                        ...
                        dotnet sonarscanner begin /k:"reservation-api" /d:sonar.host.url="http://localhost:9000/" /d:sonar.login="sqa_67e64a4198bc831a5c39c57254644e54fe08e412"  
                        
                        // Construa o projeto após iniciar a análise
                        dotnet build ctesp2425-final-gAf/ctesp2425-final-gAf.csproj --configuration Release --no-restore
